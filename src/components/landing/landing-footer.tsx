      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <motion.p
              ...
              viewport={{ once: true }}
            >
              Unlock the value of your assets without selling them. 
              Experience the future of lending with Sui blockchain technology.
            </motion.p>
        ...
        >
          <div className="max-w-md">
            ...
            <p className="text-gray-400 mb-4">Get the latest updates on new features and asset types.</p>
        ...
        >
          <p className="text-gray-400 text-sm">
            © 2026 RWA Protocol. All rights reserved.
          </p>
