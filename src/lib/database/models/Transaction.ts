...
export interface ITransaction extends Document {
  ...
  deployHash?: string; // Casper blockchain deploy hash
  ...
  // Parties involved
  initiator: string; // Wallet address that initiated the transaction
  recipient?: string; // Recipient wallet address (if applicable)
